        ...
        <div className="w-full rounded-2xl border border-slate-800/80 bg-slate-900/60 backdrop-blur-2xl p-8 shadow-[0_20px_50px_rgba(0,0,0,0.5)]">
          ...
          <div className="flex flex-col items-center justify-center mb-8">
            ...
            >
              ...
              <h1 className="text-xl font-extrabold text-white leading-tight mt-0.5">Welcome Back</h1>
              <p className="text-xs text-slate-400 mt-1">Please enter details to log in secure session</p>
            </motion.div>
          </div>
          ...
          <form onSubmit={onSubmit} className="space-y-4">
            ...
            <div className="space-y-1">
              <div className="flex items-center justify-between">
                ...
                <button type="button" className="text-[11px] font-semibold text-blue-400 hover:text-blue-300 transition hover:underline cursor-pointer">
                  Forgot?
                </button>
              </div>
              <input
            ...
            <Button type="submit" className="w-full bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-500 hover:to-indigo-500 text-white shadow-lg shadow-blue-500/25 border-0 mt-2 py-3 rounded-xl cursor-pointer" disabled={loading}>
          ...
          <p className="mt-8 text-center text-xs text-slate-400">
            ...
            <Link to="/register" className="font-bold text-blue-400 hover:text-blue-300 hover:underline">
              Create Account
            </Link>
          </p>
        </div>
